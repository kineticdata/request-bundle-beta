...
<html>
    ...
    <body class="yui-skin-sam fadedBackground2">
        <div id="display" style="width: 900px">
            <div id="details" style="float:right; width: 23em;">
                <%@include file="../shared/shadowBoxBegin.jspf"%>
                    <%
                        ...
                        if (reviewPages != null && reviewPages.size() > 0) {
                            ...
                            csrv = review.getInstanceID();
                            id = review.getCustomerSurveyRequestID();
                        }
                    %>
                    <jsp:include page="portal/callbacks/submissionSummary.html.jsp">
                        <jsp:param name="id" value="<%=id%>"/>
                        <jsp:param name="csrv" value="<%=csrv%>"/>
                    </jsp:include>
